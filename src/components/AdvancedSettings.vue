...
<template>
	<div>
		<div class="box-bar roomy">
			...
			<p>When you copy a value to the clipboard, Owl will set a timeout to automatically clear it again. You can choose how long this timeout will last.</p>
		</div>
		...
		<div class="box-bar roomy">
			...
			<p>If enabled, you will be able to use [TAB] and [ENTER] to navigate and autofill your passwords when the Owl UI is open. By default, [CTRL]+[SHIFT]+[SPACE] will open the Owl popup.</p>
		</div>
		<div class="box-bar roomy lighter">
			<div>
				<div class="switch">
		...
		<div class="box-bar roomy">
			<h4>Notification</h4>
			<p>Choose which type of notifications you want to receive from Owl.</p>
		</div>
		<div class="box-bar roomy lighter">
			<div>
				<div class="switch">
